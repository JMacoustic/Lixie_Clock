...
void loop() {
  ...
  divergence(sin(now.second()));
  if(num==7) Digit[2] = 0;
  else if (num==8) Digit[1] = 1;
...
void numMatch(int array[8], int matrix_A[2][2], int matrix_B[2][2], int matrix_C[2][2], int matrix_D[2][2]){
...
void divergence(unsigned long randomNum){
